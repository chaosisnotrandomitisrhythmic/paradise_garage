---
layout: default
title: Paradise Garage — DJ Desk Build
---

# Paradise Garage DJ Desk

A DJ/live-jam desk build inspired by the Paradise Garage, Barco Sound House Madrid, and *A Guy Called Gerald*'s live rig.
...
<div class="page-cards">
  ...
  <a href="{{ '/desk' | relative_url }}" class="page-card">
    ...
    <span>Layout dimensions, materials, isolation, and ergonomics</span>
  </a>
  <a href="{{ '/inspiration' | relative_url }}" class="page-card">
    <strong>Inspiration</strong>
    <span>Paradise Garage, Barco, A Guy Called Gerald — the live-jam ethos</span>
  </a>
  <a href="{{ '/francois-k' | relative_url }}" class="page-card">
    <strong>François K</strong>
    <span>Garage lineage, Arthur Russell remixes, live-dub rig, the 1994 library system</span>
  </a>
...
**Apr 10–12 (still valid):**

- **Modularity over aesthetics** — all gear removable for outdoor raves and B2B sets
